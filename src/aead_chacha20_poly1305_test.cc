...
char kKey[32] = {0x80, 0x81, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87,
                 0x88, 0x89, 0x8a, 0x8b, 0x8c, 0x8d, 0x8e, 0x8f,
                 0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97,
                 0x98, 0x99, 0x9a, 0x9b, 0x9c, 0x9d, 0x9e, 0x9f};

char kNonce[12] = {0x07, 0x00, 0x00, 0x00, 0x40, 0x41,
                   0x42, 0x43, 0x44, 0x45, 0x46, 0x47};

char kAAD[] = {0x50, 0x51, 0x52, 0x53, 0xc0, 0xc1,
...
TEST(AEAD_CHACHA20_POLY1305_Test, TestVector_Encrypt) {
  ...
  auto tag = Encrypt_AEAD_CHACHA20_POLY1305(kKey, kNonce, msg, kAAD);
  EXPECT_EQ(BytesToHex(tag), "1ae10b594f09e26a7e902ecbd0600691");

  EXPECT_EQ(BytesToHex(msg), "d31a8d34648e60db7b86afbc53ef7ec2"
...
TEST(AEAD_CHACHA20_POLY1305_Test, TestVector_Decrypt) {
  auto msg = HexArr("d31a8d34648e60db7b86afbc53ef7ec2"
                    "a4aded51296e08fea9e2b5a736ee62d6"
                    "3dbea45e8ca9671282fafb69da92728b"
                    "1a71de0a9e060b2905d6a5b67ecd3b36"
                    "92ddbd7f2d778b8c9803aee328091b58"
                    ...
                    "3ff4def08e4b7a9de576d26586cec64b"
                    "6116");
  Span<> msg_view(msg.data(), msg.size());

  auto tag_buf = HexArr("1ae10b594f09e26a7e902ecbd0600691");
  Poly1305 tag(tag_buf);
