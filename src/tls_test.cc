...
TEST(TLSTest, RFC8448) {
  auto client_x25519_private = curve25519::Private::From32Bytes(StrSpan(
  ...
  auto server_x25519_private = curve25519::Private::From32Bytes(StrSpan(
  ...
  auto client_hello =
      ...
      "2050206020202002d00020101001c00024001"_HexMemBuf;
  ...
  auto server_hello =
      ...
      "253b833df1dd69b1b04e751f0f002b00020304"_HexMemBuf;
  ...
  Arr<U8, 32> server_secret; // Hash-size-bytes
  ...
  Arr<U8, 16> server_handshake_key;
  Arr<U8, 12> server_handshake_iv;
  tls::HKDF_Expand_Label(server_secret, "tls13 key", ""_MemView,
                         server_handshake_key);
  tls::HKDF_Expand_Label(server_secret, "tls13 iv", ""_MemView,
                         server_handshake_iv);
